...
pre_dict = {"(个人银行标签)label.txt":"jsnx20191111","最新标注.txt":"jsnx20191121-20200109","test.txt":"jsnx20191121-20200109"}
for file in label_file:
    ...
    for line in f:
        ...
        if (len(lst) == 3):  # 有效数据
            ...
            txt_cont.append(lst)
print (txt_cont[0])
out_label = "/home/zlxu/work/VoiceClassification/data/label/label0507.txt"
