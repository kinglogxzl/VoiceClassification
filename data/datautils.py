...
def label_process(file='../label/label0507.txt', data_path='/data/voice/processed/', source_path='/data/voice/origin/'):
    label_list = ['80', '15', '56', '147', '0', '256', '48', '267', '23', '226', '54', '57', '49', '78', '6', '66',
                  '108', '160', '281', '241', '22', '203', '3', '82', '76', '73', '122', '9', '128', '251', '133',
                  '234', '155', '34', '180', '138', '185', '51', '2', '254', '79', '218', '75', '52', '258', '117',
                  '237', '219', '210', '39', '212', '240', '30', '102', '247', '69', '202', '246', '119', '113', '245',
                  '257', '211', '89', '220', '63', '209', '45', '21', '178', '24', '92', '20', '148', '1', '252', '103',
                  '259', '5', '208', '104', '101', '168', '146', '268']
    f = open(file).readlines()
    for line in f:
        lst = process_line(line)
        if (len(lst) == 3):  # 有效数据 and lst[2] in label_list
