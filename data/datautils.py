...
if __name__ == '__main__':
    label_process(file='/home/qjsun/work/VoiceClassification/data/label_copy/label_test.txt', data_path='/data/voice/processed_test/',source_path = '/data/voice/origin/')